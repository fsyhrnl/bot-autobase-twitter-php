...
// use Composer\CaBundle\CaBundle;  //disable by fer
...
class TwitterOAuth extends Config
{
    ...
    // =======  custom added @senggolbaok - ferrysyahrinal  ===== //
    public function file($url, $parameters = [])
    {
        $response = $this->oAuthRequest($url, 'GET', $parameters);
        return $response;
    }

    public function uploadb64(string $path, $parameters = [])
    {
    ...
    {
        // $bundlePath = CaBundle::getSystemCaRootBundlePath(); //disable by fer
        $options = [
            ...
            // $this->curlCaOpt($bundlePath) => $bundlePath,  //disable by fer
        ];
