...
define('WELCOME_MESSAGE', '[BOT] ' . trim(html_entity_decode('&#x1f436;')) . ' ' . trim(html_entity_decode('&#x1f436;')) . ' hai anak anjing! kamu sudah difollback! baca rules terlebih dahulu sebelum ngirim menfess yaa');
